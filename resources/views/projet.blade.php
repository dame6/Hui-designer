    ...
    <nav class="navbar navbar-expand-md  ">
     ...
     <div class="collapse navbar-collapse" id="menuhamburger">
        <ul class="navbar-nav navbar-collapse c">
          ...
          <li class="nav-item mr-4">
            <a class="nav-link active hd" href="{{ url('/nos-projets') }}" >Projets</a>
          </li>
          <li class="nav-item mr-4">
          ...
          <li class="nav-item mr-4">
           ...
           <li class="nav-item">
            <a href="{{ url('/nos-projets_dark') }}" class="nav-link mode hd" ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-moon-fill" viewBox="0 0 16 16">
        ...
        <div class="tab-content" id="nav-tabContent">
          ...
          <div class="projet-3 ">
            ...
            <div class="img-02" style="background-image: url('{{ asset('uploads/'.$projet->img) }}')"><p class="projet0-3">{{ $projet->categorie }}</p></div>
              ...
              <a href="{{ url('/projet/'.$projet->id) }}" class="projet-bt-1">Voir la use case</a>
            </div>
