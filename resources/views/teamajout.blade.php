      ...
      @csrf
              <div class="form-row">
                <div class=" form-group" >
                  <input type="text" name="nom" class="form-control ajout-1"  placeholder="Nom du membre" />
                </div>
                <div class=" form-group">
                  <input type="text" class="form-control ajout-1" name="titre"  placeholder="Titre du membre"/>
        
                </div>
              </div>
               <div class="form-row">
                <div class=" form-group">
                  <input type="text" name="linkedin" class="form-control ajout-1" placeholder="Lien Linkedin"
                    data-rule="minlen:4" data-msg="Please enter at least 4 chars" />
                </div>
                <div class=" form-group">
                  <input type="text" class="form-control ajout-1" name="twitter"  placeholder="Lien twitter"/>
        ...
        <input type="submit" class="ajout-bt-2" value="Enrégistrer le membre" />    
      </form>
    </div>
    
  </div>
</section>
@elseif ($layout == 'editteam')
<section class="mb-5">
  <div class="container">
    <div class="row justify-content-center mb-5">
     <form action="{{ url('/updateteam/'.$team->id) }}" method="post" enctype="multipart/form-data" >
      @csrf
              <div class="form-row">
                <div class=" form-group" >
                  <input type="text" name="nom" value="{{ $team->nom }}" class="form-control ajout-1"  placeholder="Nom du membre" />
                </div>
                <div class=" form-group">
                  <input type="text" class="form-control ajout-1" name="titre" value="{{ $team->titre }}"  placeholder="Titre du membre"/>
        
                </div>
              </div>
               <div class="form-row">
                <div class=" form-group">
                  <input type="text" name="linkedin" value="{{ $team->linkedin }}" class="form-control ajout-1" placeholder="Lien Linkedin"
                    data-rule="minlen:4" data-msg="Please enter at least 4 chars" />
                </div>
                <div class=" form-group">
                  <input type="text" class="form-control ajout-1" name="twitter" value="{{ $team->twitter }}" placeholder="Lien twitter"/>
            
                </div>
              </div>
              <div class="form-group">
                <div class=" form-group" >
                  <input type="file" name="img" value="{{ $team->img }}" class="form-control ajout-1" 
                    />
                </div>
