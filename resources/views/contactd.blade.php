 ...
 <nav class="navbar navbar-expand-md  ">
     ...
     <div class="collapse navbar-collapse" id="menuhamburger">
        <ul class="navbar-nav navbar-collapse c">
          ...
          <li class="nav-item mr-4">
            <a class="nav-link active hd" href="{{ url('/contact_dark') }}">Contact</a>
          </li>
           <li class="nav-item">
            <a href="{{ url('/contact') }}" class="nav-link mode hd" ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-moon-fill" viewBox="0 0 16 16">
