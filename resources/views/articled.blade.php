     ...
     <div class="collapse navbar-collapse" id="menuhamburger">
        <ul class="navbar-nav navbar-collapse c">
          ...
          <li class="nav-item mr-4">
           ...
           <li class="nav-item">
            <a href="{{ url('/nos-articles') }}" class="nav-link mode hd" ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-moon-fill" viewBox="0 0 16 16">
     ...
     <section id="about" class="about-apro ">
      ...
      <div class="container">
        <div class="row justify-content-center">
          ...
          <div class=" article-1">
            <a href="{{ url('/article_dark/'.$article->id) }}" class="article-4">
            <div class="icon-box">
