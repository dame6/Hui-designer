...
<body class="body1">
  ...
  <div class="container">
   <div >
     <div class="img-ad-01" style="background-image: url('img/group-2.png');">
      <h2 class="artad-1">Liste des feedbacks</h2>
      <a href="{{ url('/creer-testim') }}" class="artad-2">Ajouter une nouvelle Testim</a>
     </div>
 ...
 <section class="parle mb-5">
      <div class="container">
        <div class="row justify-content-center">
        
            @foreach($testims as $testim)
            <div class="parle-2">
            <h4 class="parle-4">{{ $testim->prenom }}</h4><div class="nav-item dropdown mr-4 " style="margin: -40px 0px 0px 180px">
            <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true"
              aria-expanded="false" style="color: black;"></a>
            <div class="dropdown-menu">
              <a class="dropdown-item" href="{{ url('/Modifier-testim/'.$testim->id) }}"><i class="mr-2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil" viewBox="0 0 16 16">
  <path d="M12.146.146a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1 0 .708l-10 10a.5.5 0 0 1-.168.11l-5 2a.5.5 0 0 1-.65-.65l2-5a.5.5 0 0 1 .11-.168l10-10zM11.207 2.5 13.5 4.793 14.793 3.5 12.5 1.207 11.207 2.5zm1.586 3L10.5 3.207 4 9.707V10h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.293l6.5-6.5zm-9.761 5.175-.106.106-1.528 3.821 3.821-1.528.106-.106A.5.5 0 0 1 5 12.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.468-.325z"/>
</svg></i>Modifier</a>
              <a class="dropdown-item" href="{{ url('/supptestim/'.$testim->id) }}"><i class="mr-2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
  ...
  <path fill-rule="evenodd" d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1v1zM4.118 4 4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4H4.118zM2.5 3V2h11v1h-11z"/>
            ...
            <div class="img-05" style="background-image: url('{{ asset('uploads/'.$testim->img) }}');"></div></div>
            @endforeach
        </div>
      </div>
    </section>
