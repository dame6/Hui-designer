     ...
     <div class="collapse navbar-collapse" id="menuhamburger">
        <ul class="navbar-nav navbar-collapse c">
          ...
          <li class="nav-item mr-4">
           ...
           <li class="nav-item">
            <a href="{{ url('/nos-projets') }}" class="nav-link mode hd" ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-moon-fill" viewBox="0 0 16 16">
     ...
     <section id="about " class="about-apro ">
      <div class="container mt-5" >
        ...
        <div class="row justify-content-center">
          ...
          <div class="">
              <h4 class="about-pro-1">Sur quoi avons - nous travaillé ?</h4>
              <p class="about-pro-2">À travers des itérations de projets et des découvertes profondes avec tous nos clients et membres de la communauté, grâce à l'exécution, nous ne nous contentons pas de fournir des résultats, nous vous aidons à vous familiariser avec le processus et à vous informer sur la façon de progresser et de commencer à poser les bonnes questions.</p>
              
          </div>
           <div>
             <img src="img/15.png" class="img-apro-01">
          </div>
        </div>
       ...
       <div class="container">
        ...
        <div class="tab-content" id="nav-tabContent">
          ...
          <div class="projet-3 ">
            ...
            <div class="icon-box">
            <div class="img-02" style="background-image: url('{{ asset('uploads/'.$projet->img) }}')"><p class="projet0-3">{{ $projet->categorie }}</p></div>
              <h4 class="projet-4">{{ $projet->titre }}</h4>
              <p class="projet-5">{{ $projet->description }}</p>
              <a href="{{ url('/projet_dark/'.$projet->id) }}" class="projet-bt-1">Voir la use case</a>
            </div>
